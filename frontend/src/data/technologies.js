export const TECHNOLOGIES = [
    ...
    },
    {
        ...
        shortTitle: 'IPL',
        iconName: 'Sun',
        description: 'Yoğun atımlı ışık tedavileri ile vasküler lezyonlar, akne kontrolü, leke giderme ve foto-gençleştirme için geniş spektrumlu filtreleme sistemleri.',
    ...
    },
    {
        ...
        shortTitle: 'EMS',
        iconName: 'Dumbbell',
        description: 'Yüksek yoğunluklu elektromanyetik kas stimülasyonu ile eş zamanlı kas geliştirme, yağ azaltma ve pelvik taban güçlendirme.',
    ...
    },
    {
        ...
        description: 'Yüksek enerjili akustik basınç dalgaları (AWT) ile selülit görünümünün azaltılması, doku yeniden yapılandırma ve mikro-dolaşımın artırılması.',
        applications: ['Selülit Tedavisi', 'Doku Yenileme', 'Mikro-dolaşım', 'AWT'],
    },
];
export const getTechnology = (id) => TECHNOLOGIES.find((t) => t.id === id);
